<html>
    ...
    /////////////////// MYSQL 
        ...
        // $sql4 = "SELECT * FROM dreamteam";
        // $dream = $conn->query($sql4);

        // $sql5 = "INSERT INTO dreamteam VALUES(default, ?, ?, ?, ?, ?)";
        // $stmt = $conn->prepare($sql5);
        // //$stmt->execute([$name, $club, $position, $nationality]);
    ...
    <div class = "container-fluid mx-auto" style="width: 75%; height:auto; background-color:light-grey">
        ...
        <table class="styled-table">
        <caption style="text-align:center; caption-side:top"><h3>Player Statistic</h3></caption>
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Club</th>
                ...
                <?php       
                    foreach ($data as $cursor){
                        echo "<tr class='active-row'>
                                ...
                                <td>" .$cursor["Red_Cards"]. "</td>"
                ?>
                                <td><button name ="add" id="add" class="btn btn-success"><i class="lnr lnr-plus-circle"></i>Add</button></td>
                <?php 
                            "</tr>";
                    }
                ?>
    ...
    <div id="content4" style="height: 50px"></div>
        <div style="width: 100%; height: auto;">
            ...
            <div id="away" style="width: 50%; height: auto; float: right;">
        ...
        <div style="width: 100%; height: auto;">
            <div id="age" style="width: 50%; height: auto; float: left;">
                ...
                <script type="text/javascript">
                    ...
                    options: {
                        ...
                        title: {
                        display: true,
                        text: "Youngster Age <= 23"
                        },
                        scales: {
                        xAxes: [{ticks: {min: 0, max:19}}]
                        }
                    }
                    });
                </script>
